function snowFlake2_Log(FlakeType,Title,Categories,Intensity)
N = 4;
TEXT1 = Categories{1};
TEXT2 = Categories{2};
TEXT3 = Categories{3};
...
Angles = (360/N.*[0:1:N-1]+90).*pi/180;
...
Line1 = [0+0j 0+1j];
Line2 = Line1.*exp(1j*2*pi/N);
Line3 = Line2.*exp(1j*2*pi/N);
Line4 = Line3.*exp(1j*2*pi/N);
...
text3 = text(real(Line3(2)),imag(Line3(2)),TEXT3,...
        'VerticalAlignment','bottom','HorizontalAlignment','center',...
        'FontWeight','bold','fontsize',14,'color','white','interpreter','latex');
set(text3,'Rotation',180);
text4 = text(real(Line4(2)),imag(Line4(2)),TEXT4,...
        'VerticalAlignment','bottom','HorizontalAlignment','center',...
        'FontWeight','bold','fontsize',14,'color','white','interpreter','latex');
set(text4,'Rotation',-90);
